<template>
    <div id="login_id">
        ...
        <transition name="fade">
            <div v-cloak v-if="isShowReturnInfoFlag" :class="{'tsama-tip-info-error':errorMessageFlag,'tsama-tip-info-success':!errorMessageFlag}">
                <div>
        ...
        <div style="overflow: hidden;margin-top: 80px;">
            ...
            <div style="width:12em;float: left;position: fixed;left: 0;top: 110px;">
                <div class="tsama-info-left-menu" v-on:click="getInfo(0)" :class="{'tsama-info-left-menu-active':active==0}">
                    <!--<div style="margin-top: 4px;float: left;margin-left: 3.5em;">
						<icon :scale="2.2" name="infoleftsvg"></icon>
					</div>-->
                    <span>个人信息</span>
                </div>
                ...
                <div class="tsama-info-left-menu" v-on:click="getInfo(3)" :class="{'tsama-info-left-menu-active':active==2}">
                    <!--<div style="clear:left;float: left;margin-left: 3.5em;">
						<icon :scale="2.2" name="courseIcon"></icon>
					</div>-->
                    <span>行程跟踪详情</span>
            ...
            <div style="background: #ECECEC;width: 100%;height: 100%;margin-left: 12em;min-height: 1280px;padding: 0.1em 1em; padding-bottom: 20em;">
                <div v-if="active==0" v-cloak>
                    ...
                    <div style="margin-top: 50px;">
                        <div><span style="font-size: 1.3em;float: left;"><b>背景/头像</b></span></div>
                        <div><img :src="imgUrl" style="height: 400px;width:300px;margin-left: 50px;float: left;" />
                        </div>
                        <div><img :src="imgUrl" style="height: 200px;width:150px;margin-left: 50px; border: 2px solid white;margin-top: 44px;" />
                        </div>
                        <div style="clear: left;margin-left: 15em;margin-top: 11.5em;">
                    ...
                    <div style="margin-top: 50px;">
                        ...
                        <div style="padding: 1em;position: relative;">
                            ...
                            <input type="text" v-on:blur="toBlur(0)" v-on:focus="toFocus(0)" id="inputNameCN" class="form-control" style="width: 300px;margin-left: 110px;" v-model="cnName" placeholder="请输入您的中文名">
                            <transition name="fade">
                    ...
                    <div style="margin-top: 50px;">
                        ...
                        <div style="padding: 1em;position: relative;">
                            ...
                            <input type="phone" id="inputPhone" class="form-control" style="width: 300px;margin-left: 110px;" readonly="readonly" v-model="phone" placeholder="请输入您的手机号">
                        </div>
                        <!--<div style="padding: 1em;position: relative;">
                    ...
                    <div style="margin-top: 50px;">
                        ...
                        <div style="padding: 1em;position: relative;">
                            ...
                            <input type="text" v-on:blur="toBlur(4)" v-on:focus="toFocus(4)" id="inputMainPoster" class="form-control" style="width: 300px;margin-left: 110px;" v-model="title" placeholder="请输入您的职称">
                            <transition name="fade">
                        ...
                        <div style="padding: 1em;position: relative;">
                            <div>
                                ...
                                style="position: absolute;color: red;margin-top: 3px;font-size: 1.1em;margin-left: 69px;">*</span></label>
                                <div v-cloak>
                                    <input type="text" v-on:blur="toBlur(14)" v-on:focus="toFocus(14)" class="form-control" style="width: 300px;margin-left: 110px;margin-bottom: 10px;" v-model="department" placeholder="请输入您的工作单位">
                                    <transition name="fade">
                        ...
                        <div style="padding: 1em;position: relative;">
                            <label for="inputIntroduction" style="float: left;line-height: 35px;">个人简介<span
                                style="position: absolute;color: red;margin-top: 3px;font-size: 1.1em;margin-left: 41px;">*</span></label>
                            <textarea type="text" v-on:blur="toBlur(6)" v-on:focus="toFocus(6)" id="inputIntroduction" class="form-control" style="width: 300px;margin-left: 110px;height: 100px;" v-model="introduction" placeholder="个人简介"></textarea>
                            <transition name="fade">
                    ...
                    <div style="margin-top: 50px;">
                        ...
                        <transition name="fade">
                            <div v-cloak style="padding: 1em;position: relative;margin-left: 110px;" v-if="isShowFixPasswordFlag">
                                <label for="inputPassword" style="float: left;line-height: 35px;">新密码<span
                                    style="position: absolute;color: red;margin-top: 3px;font-size: 1.1em;margin-left: 55px;">*</span></label>
                                <input type="password" v-on:blur="toBlur(7)" v-on:focus="toFocus(7)" id="inputPassword" class="form-control" style="width: 300px;margin-left: 110px;" v-model="newPassword" placeholder="请输入您的新密码">
                                <label for="inputPassword" style="float: left;line-height: 35px;margin-left: -42px;">再次输入<span
                                    style="position: absolute;color: red;margin-top: 3px;font-size: 1.1em;margin-left: 41px;">*</span></label>
                                <input type="password" v-on:blur="toBlur(8)" v-on:focus="toFocus(8)" id="inputRePassword" class="form-control" style="width: 300px;margin-left: 110px;" v-model="reNewPassword" placeholder="请再次输入您的新密码">
                                <transition name="fade">
                                    ...
                                    <label v-cloak v-if="passwordErrorNull" style="position: absolute;top: 20px;left: 430px;color: red">（必须）</label>
                                    <label v-cloak v-if="passwordErrorLength" style="position: absolute;top: 20px;left: 430px;color: red">（密码长度为6-20位）</label>
                                    <label v-cloak v-if="rePasswordErrorNoEq" style="position: absolute;top: 55px;left: 430px;color: red">（两次密码输入不一致）</label>
                                </transition>
                    ...
                    <div style="margin-top: 50px;">
                        ...
                        <div style="padding: 1em;position: relative;">
                            <label for="inputCourseName" style="float: left;line-height: 35px;">课程名称<span
                                style="position: absolute;color: red;margin-top: 3px;font-size: 1.1em;margin-left: 41px;">*</span></label>
                            <input type="text" v-on:blur="toBlur(9)" v-on:focus="toFocus(9)" id="inputCourseName" class="form-control" style="width: 300px;margin-left: 110px;" v-model="courseName" placeholder="课程名称">
                            <transition name="fade">
                        ...
                        <div style="padding: 1em;position: relative;">
                            <label for="inputCourseIntroduction" style="float: left;line-height: 35px;">课程简介<span
                                style="position: absolute;color: red;margin-top: 3px;font-size: 1.1em;margin-left: 41px;">*</span></label>
                            <textarea type="text" v-on:blur="toBlur(10)" v-on:focus="toFocus(10)" id="inputCourseIntroduction" class="form-control" style="width: 300px;margin-left: 110px;height: 100px;" v-model="courseIntroduction" placeholder="课程简介"></textarea>
                            <transition name="fade">
                        ...
                        <div v-for=" item in timeLocals">
                            <div style="padding: 1em;position: relative;">
                                <label style="float: left;line-height: 35px;">开设班名<span
                                    style="position: absolute;color: red;margin-top: 3px;font-size: 1.1em;margin-left: 41px;">*</span></label>
                                <select class="form-control" v-model="item.ban" style="width: 300px;margin-left: 110px;">
                            ...
                            <div style="padding: 0 1em;position: relative;">
                                ...
                                <date-picker field="myDate" style="width: 300px;margin-left: 110px;" placeholder="开课时间" v-model="item.timeStart" format="yyyy/mm/dd" :backward="false" :no-today="false" :forward="false"></date-picker>
                            </div>
                            ...
                            <date-picker field="myDate1" style="width: 300px;margin-left: 125px;" placeholder="截止时间" v-model="item.timeStop" format="yyyy/mm/dd" :backward="false" :no-today="false" :forward="false"></date-picker>
...
<script>
    ...
    import scheduleTrackingDetail from './Professor/courseTrackingDetail'
    export default {
        name: 'ExpertInfo',
        components: {
