<template>
    <div :style="`height:${heightBrower-80}px; width:80%; max-width:1400px;margin:0 auto;margin-top:50px;`">    
        ...
        <div class="courseContainer">
            ...
            <p style="clear:both;">
                <span style="border-bottom: 3px solid #19568a;">课程内容</span>
            </p>
            <p>没有人知道失败和成功间的差距是多么得小。它们之间只相差了一个词的距离，那就是胆怯。问一问福特，问一问爱迪生，问一问所有已经获得成功的人，他们会告诉你，把失败从成功中分割开的裂沟是多么得狭窄，也会明确地告诉你，依靠坚持和信念必然可以让人从失败走向成功。
